...
namespace SpaceSim.Ship
{
    public class ShipInput : MonoBehaviour
    {
        ...
        /// </summary>
        private void UpdateThrottleKeyboard(KeyCode _increaseKey, KeyCode _decreaseKey)
        {
            ...
            else if (Input.GetKey(_decreaseKey))
            {
                target = 0;
            }
        ...
        /// Get mouse keys for accelerator
        /// </summary>
        private void UpdateRollKeyboard(KeyCode _increaseKey, KeyCode _decreaseKey)
        {
            float target = 0;
            if (Input.GetKey(_increaseKey))
            {
